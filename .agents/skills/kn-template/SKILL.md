...
- `/kn-extract` - Decide whether a repeated pattern justifies a template at all
- `/kn-doc` - Create the linked pattern doc a template requires

## Red Flags

- Generating real files without a dry run first
- Creating a template without a linked pattern doc
- Overlapping an existing template instead of updating it
- Building delimiters through string concatenation
