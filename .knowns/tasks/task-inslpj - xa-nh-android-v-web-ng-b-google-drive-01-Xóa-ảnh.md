...
updatedAt: '2026-08-26T04:57:53.951Z'
timeSpent: 0
assignee: '@me'
...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Ảnh bị xóa khỏi local database/file path và không còn trong danh sách ảnh đang hoạt động.
- [ ] #2 Xóa ảnh cuối cùng làm thư mục media local rỗng được xóa, nhưng không tạo thao tác xóa Firebase/Google Drive.
- [ ] #3 Sự kiện xóa chứa projectId, photoId, folder/object identity và timestamp, được ghi vào outbox khi offline và retry idempotent khi online.
- [ ] #4 Ảnh Android còn lại không bị đánh dấu xóa hoặc tái tạo do sync.
<!-- AC:END -->
