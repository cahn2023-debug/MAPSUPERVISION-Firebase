---
id: doc-d418befc2828fded54fabfa2cc945d72
title: Firebase Project Catalog Recovery Approved
description: Approved canonical specification for repairing Android Firebase project catalogs, backfilling legacy projects, aligning createdByUid rules, and surfacing migration warnings.
createdAt: '2026-08-24T02:39:00.655Z'
updatedAt: '2026-08-24T03:04:32.894Z'
tags:
  - spec
  - approved
  - firebase
...
Spec này đã được duyệt và thay thế có giới hạn hợp đồng catalog trong @doc/specs/2026-08-23/firebase-project-sync-approval-approved: D1, FR-3 và NFR-2 được mở rộng để cho phép `createdByUid`. Các quyết định và yêu cầu khác của spec gốc vẫn giữ nguyên.
...
- Impact: draft new
- Decision: @decision/20260824-0931-public-project-catalog-ownership-metadata-and-recovery
...
- `ry4iav` — [firebase-project-catalog-recovery-01] Chuẩn hóa hợp đồng catalog và mọi writer — todo
- `ly12b4` — [firebase-project-catalog-recovery-02] Khôi phục catalog bằng migration idempotent — todo
- `u5blkn` — [firebase-project-catalog-recovery-03] Hiển thị cảnh báo admin và lỗi catalog chính xác — todo
- `i7odyl` — [firebase-project-catalog-recovery-04] Xác minh bảo mật và hồi quy catalog — todo
- `gh61ke` — [firebase-project-catalog-recovery-05] Khôi phục Firebase production có kiểm soát — todo
